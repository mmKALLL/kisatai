...
export const sprites = {
  ...
  titleHover: require('./assets/sprites/irastoya-nigaoe_itagaki_taisuke-face.png'),
  ...
  // FIXME: These are for demo use TODO
  characterBase: require('./assets/sprites/character.png'),
  Katshuma: require('./assets/sprites/irasutoya-sports_boxing_woman.png'),
  KatshumaSmall: require('./assets/sprites/irasutoya-sports_boxing_woman-face.png'),
  mmKALLL: require('./assets/sprites/irastoya-nigaoe_itagaki_taisuke.png'),
  mmKALLLSmall: require('./assets/sprites/irastoya-nigaoe_itagaki_taisuke-face.png'),
  TruemmKALLL: require('./assets/sprites/irasutoya-fantasy_wolfman.png'),
  TruemmKALLLSmall: require('./assets/sprites/irasutoya-fantasy_wolfman-face.png'),
